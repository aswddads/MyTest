package tj.com.mysdk.core.video;

import android.view.ViewGroup;

import com.google.gson.Gson;

import tj.com.mysdk.constant.Utils;
import tj.com.mysdk.core.AdContextInterface;
import tj.com.mysdk.module.AdValue;
import tj.com.mysdk.okhttp.HttpConstant;
import tj.com.mysdk.report.ReportManager;
import tj.com.mysdk.widget.CustomVideoView;
...
public class VideoAdContext implements VideoAdSlot.AdSDKSlotListener {
    ...
    public VideoAdContext(ViewGroup parentView, String instance,
        ...
        Gson gson=new Gson();
        this.mInstance = (AdValue) gson.fromJson(instance, AdValue.class);
